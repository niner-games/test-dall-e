...
<h1 align="center">DALL·E 2 - OpenAI Test</h1><br />

Test of DALL·E 2, an OpenAI image generator. Version that is available free of charge inside Microsoft Edge browser.

The version of DALL·E 2 that is available free of charge for user of Microsoft Edge browser
(logged into their Microsoft Account) allows to provide a short description text (up to 250 characters)
and generates four different images matching it. Depending on the description, results are from
